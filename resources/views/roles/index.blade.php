    ...
    <div>
        ...
        <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="block mb-8">
                <a href="{{ route('roles.create') }}" class="bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded">Add Role</a>
            </div>
                                ...
                                @foreach ($roles as $role)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <a href="{{ route('roles.show', $role->id) }}" class="text-blue-600 hover:text-blue-900 mb-2 mr-2">View</a>
